...
| v0.7 | **草坪编辑器(G)、建筑编辑器(B)、道路编辑器(R)**、GLB 模型导入、存档系统、小地图 |
...
| 修复 | Bloom CDN 加载顺序、boot 单步隔离、窗户冲出屋顶修复 |
| 数据 | 校园建筑物实际位置校准、道路路线调整 |
...
| 版本 | 内容 | 负责人 |
|------|------|--------|
| v0.1 | UI 骨架 + 场景初始化 | 涂怀夫 |
| v0.2 | 地坪 + 路网 + 运动设施 | 涂怀夫 |
| v0.3 | ~44 栋校园建筑 | 涂怀夫 + 姚志刚(位置校准) |
| v0.4 | 植被 + 设施 | 涂怀夫 |
| v0.5 | 日夜循环 | 涂怀夫 |
| v0.6 | 自动观光 + 自由漫游 + 小地图 | 涂怀夫 |
| v0.7 | 场景编辑器 + GLB 导入 + 存档系统 | 涂怀夫 |
| v0.7+ | 天空穹顶 + 标签 + 泛光 + 粒子 | 姚志刚 |
